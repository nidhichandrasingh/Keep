...
Tops = Frame(root,bg="powder blue",width = 1600,height=50,relief=SUNKEN)
Tops.pack(side=TOP)
...
#INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,50, 'bold' ),text="Restaurant Management System",fg="steel blue",bd=10,anchor='w')
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-.........",bd=2,relief=SUNKEN)
